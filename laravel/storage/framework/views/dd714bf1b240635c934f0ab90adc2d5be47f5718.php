<?php $__env->startSection('title', 'Bize Ulaşın'); ?>
    ...
    <div class="col-12 contact-us">
        ...
        <div class="row contact-content">
            ...
            <div class="col-xl-3 col-md-6 line">
                ...
                <p class="phone"><?php echo e($iletisim->tel); ?></p>
            </div>
            <div class="col-xl-3 col-md-6 line">
                <img src="assets/images/mail_b@2x.png" alt="">
                <p class="big-text"><a href="mailto:<?php echo e($iletisim->mail); ?>"><?php echo e($iletisim->mail); ?></a></p>
            </div>
            <div class="col-xl-3 col-md-6 social">
                <ul class="list-inline">
                    <li class="list-inline-item"><a href="<?php echo e($iletisim->facebook); ?>"><i class="fab fa-facebook-f"></i></a></li>
                    <li class="list-inline-item"><a href="<?php echo e($iletisim->instagram); ?>"><i class="fab fa-instagram"></i></a></li>
                    <li class="list-inline-item"><a href="<?php echo e($iletisim->twitter); ?>"><i class="fab fa-twitter"></i></a></li>
                    <li class="list-inline-item"><a href="<?php echo e($iletisim->linkedin); ?>"><i class="fab fa-linkedin-in"></i></a></li>
                </ul>
                <p class="big-text"><?php echo e(str_replace(['http://', 'https://'], '', url('/'))); ?></p>
            </div>
        </div>
