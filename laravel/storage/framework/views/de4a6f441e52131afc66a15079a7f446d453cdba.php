        ...
        <div class="basket-table">
            <div class="basket-tt">
                ...
                <div class="row table-line total-row cargo">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 table-inner-line prices offset-xl-2 offset-lg-2 <?php if($toplam_k >= $limit): ?> free-text <?php endif; ?>">
                        <p style="<?php if($toplam_k < $limit): ?> display: none <?php endif; ?>"><?php echo e($limit); ?> TL ve üzeri</p>
                        <span style="font-weight: 800; <?php if($toplam_k < $limit): ?> display: none <?php endif; ?>">Kargo BEDAVA</span>
                        <span class="price total" style="<?php if($toplam_k >= $limit): ?> line-height: 40px <?php endif; ?>"><?php echo e(number_format($kargo, 2, ',', '.')); ?> TL</span>
                    </div>
                </div>
                ...
                <div class="row table-line total-row amount">
                    ...
                    <div class="col-xl-4 col-lg-4 col-md-12 table-inner-line prices <?php if($hasDiscount): ?> free-text <?php endif; ?>">
                    	<div class="has-discount" <?php if(!$hasDiscount): ?> style="display: none" <?php endif; ?>>
                            <p>İlk alışverişinize özel</p>
                            <span style="font-weight: 800"> <text><?php echo e($hasDiscount ? $indirim['b'] : null); ?></text> TL indirim kazandınız! </span>
                            <span class="old" style="font-weight: 800; margin-top: 10px"><?php echo e($hasDiscount ? number_format($indirimsiz, 2, ',', '.') : null); ?> TL</span>
                        </div>
                        <span class="price total" <?php if($hasDiscount): ?> style="line-height: 20px" <?php endif; ?>><?php echo e(number_format($hasDiscount ? $indirimli : $toplam, 2, ',', '.')); ?> TL</span>
                    </div>
                </div>
            </div>
