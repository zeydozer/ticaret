...
<?php $__env->startSection('title', $title[Request::path()]); ?>
...
<?php if(Request::path() == 'hakkimizda'): ?>
<div class="container">
            ...
            <main id="main" class="site-main" role="main">
                <article id="post-6" class="post-6 page type-page status-publish hentry">
                    <div class="row">
                        <div class="col-12">
                            <header>
                                <h1 class="page-title margin-top"><?php echo e($seo['author']); ?> Hakkında</h1>
                            </header>
                        </div>
                    </div>
                    <div class="row">
                    	<div class="col-md-6">
                    		<h5>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut pretium magna non tincidunt aliquam. Nam ullamcorper, enim eget ullamcorper luctus, turpis velit convallis tortor, nec maximus ligula tortor a enim. Proin eros mi, porta eget purus a, ornare suscipit ligula. Pellentesque vehicula aliquam ipsum ac condimentum. Aliquam erat volutpat. Proin accumsan dolor tortor, nec maximus justo gravida id. Vestibulum commodo metus vitae quam aliquam vestibulum id quis arcu.</h5>
                            <h5>Aliquam ullamcorper urna nec urna sodales, sed aliquam est gravida. Vestibulum ac enim non lorem dignissim rhoncus. Phasellus commodo venenatis risus, nec hendrerit ex molestie condimentum. Ut eu vulputate nibh. Aenean lobortis magna vitae convallis pharetra. Nunc ullamcorper dignissim nisi nec porttitor. Donec tristique dui vitae mi dignissim, vitae euismod quam mattis. Aliquam erat volutpat. Ut sit amet lorem mattis, faucibus felis et, posuere nunc. Integer mattis odio facilisis, dictum nulla non, iaculis augue. Nulla dictum metus ac nulla rutrum hendrerit. Proin venenatis lacus nec turpis iaculis rutrum. Sed sed lectus scelerisque, sodales odio eu, laoreet augue. Nulla pharetra diam est, et tristique ex scelerisque maximus.</h5>
                    	</div>
                    	<div class="col-md-6">
                            <img src="/img/500x500.png" alt="<?php echo e($seo['author']); ?> Hakkında" width="100%" height="100%" style="object-fit: contain;">
                        </div>
                    </div>
                </article>
                <!-- #post-## -->
...
<?php elseif(Request::path() == 'kullanim-kosullari'): ?>
...
<?php elseif(Request::path() == 'gizlilik-politikasi'): ?>
...
<?php elseif(Request::path() == 'garanti-politikasi'): ?>
...
<?php elseif(Request::path() == 'iptal-iade-degisim'): ?>
...
<?php elseif(Request::path() == 'satis-sozlesmesi'): ?>
        ...
        <div id="primary" class="content-area col-xs-12">
            <main id="main" class="site-main" role="main">
                <article id="post-13" class="post-13 page type-page status-publish hentry">
                    ...
                    <p>SATICI: <?php echo e($seo['author']); ?> <br>Adres: <?php echo e($iletisim['adres']); ?> <br>Vergi Dairesi: GÜNEŞLİ<br>Vergi Numarası: 3250596478<br>Ticari Sicil: İstanbul Ticaret Odası 36658-5<br>Telefon: <?php echo e($iletisim['tel']); ?><br>Email: info<?php echo e('@'. str_replace(['http://', 'https://'], '', url('/'))); ?></p>
                    <p>Bu internet sitesine girmeniz veya bu internet sitesindeki herhangi bir bilgiyi kullanmanız aşağıdaki koşulları kabul ettiğiniz anlamına gelir.</p>
                    <p>Bu internet sitesine girilmesi, sitenin ya da sitedeki bilgilerin ve diğer verilerin programların vs. kullanılması sebebiyle, sözleşmenin ihlali, haksız fiil, ya da başkaca sebeplere binaen, doğabilecek doğrudan ya da dolaylı hiçbir zarardan <?php echo e($seo['author']); ?>  sorumlu değildir. <?php echo e($seo['author']); ?> , sözleşmenin ihlali, haksız fiil, ihmal veya diğer sebepler neticesinde; işlemin kesintiye uğraması, hata, ihmal, kesinti hususunda herhangi bir sorumluluk kabul etmez.</p>
                    <p><?php echo e($seo['author']); ?>  işbu site ve site uzantısında mevcut her tür hizmet, ürün, siteyi kullanma koşulları ile sitede sunulan bilgileri önceden bir ihtara gerek olmaksızın değiştirme, siteyi yeniden organize etme, yayını durdurma hakkını saklı tutar. Değişiklikler sitede yayım anında yürürlüğe girer. Sitenin kullanımı ya da siteye giriş ile bu değişiklikler de kabul edilmiş sayılır. Bu koşullar link verilen diğer web sayfaları için de geçerlidir.</p>
                    <p><?php echo e($seo['author']); ?> , sözleşmenin ihlali, haksız fiil, ihmal veya diğer sebepler neticesinde; işlemin kesintiye uğraması, hata, ihmal, kesinti, silinme, kayıp, işlemin veya iletişimin gecikmesi, bilgisayar virüsü, iletişim hatası, hırsızlık, imha veya izinsiz olarak kayıtlara girilmesi, değiştirilmesi veya kullanılması hususunda herhangi bir sorumluluk kabul etmez.</p>
                    <p>Bu internet sitesi <?php echo e($seo['author']); ?> ’in kontrolü altında olmayan başka internet sitelerine bağlantı veya referans içerebilir. <?php echo e($seo['author']); ?> , bu sitelerin içerikleri veya içerdikleri diğer bağlantılardan sorumlu değildir.</p>
                    <p><?php echo e($seo['author']); ?>  bu internet sitesinin genel görünüm ve dizaynı ile internet sitesindeki tüm bilgi, resim, <?php echo e($seo['author']); ?> markası ve diğer markalar, <?php echo e(str_replace(['http://', 'https://'], '', url('/'))); ?> alan adı, logo, ikon, demonstratif, yazılı, elektronik, grafik veya makinede okunabilir şekilde sunulan teknik veriler, bilgisayar yazılımları, uygulanan satış sistemi, iş metodu ve iş modeli de dahil tüm materyallerin (“Materyaller”) ve bunlara ilişkin fikri ve sınai mülkiyet haklarının sahibi veya lisans sahibidir ve yasal koruma altındadır. İnternet sitesinde bulunan hiçbir Materyal; önceden izin alınmadan ve kaynak gösterilmeden, kod ve yazılım da dahil olmak üzere, değiştirilemez, kopyalanamaz, çoğaltılamaz, başka bir lisana çevrilemez, yeniden yayımlanamaz, başka bir bilgisayara yüklenemez, postalanamaz, iletilemez, sunulamaz ya da dağıtılamaz. İnternet sitesinin bütünü veya bir kısmı başka bir internet sitesinde izinsiz olarak kullanılamaz. Aksine hareketler hukuki ve cezai sorumluluğu gerektirir. <?php echo e($seo['author']); ?> ’nin burada açıkça belirtilmeyen diğer tüm hakları saklıdır.</p>
                    <p>Müşterinin sisteme girdiği tüm bilgilere sadece Müşteri ulaşabilmekte ve bu bilgileri sadece Müşteri değiştirebilmektedir. Bir başkasının bu bilgilere ulaşması ve bunları değiştirmesi mümkün değildir. Ödeme sayfasında istenen kredi kartı bilgileriniz, siteden alışveriş yapan siz değerli müşterilerimizin güvenliğini en üst seviyede tutmak amacıyla hiçbir şekilde <?php echo e(str_replace(['http://', 'https://'], '', url('/'))); ?> veya ona hizmet veren şirketlerin sunucularında tutulmamaktadır. Bu şekilde ödemeye yönelik tüm işlemlerin <?php echo e(str_replace(['http://', 'https://'], '', url('/'))); ?> ara yüzü üzerinden banka ve bilgisayarınız arasında gerçekleşmesi sağlanmaktadır.</p>
                    <p><?php echo e($seo['author']); ?> , dilediği zaman bu yasal uyarı sayfasının içeriğini güncelleme yetkisini saklı tutmaktadır ve kullanıcılarına siteye her girişte yasal uyarı sayfasını ziyaret etmelerini tavsiye etmektedir.</p>
                    <p><br>Adres: …<br>Vergi Dairesi: …<br>Vergi Numarası: …<br>Ticari Sicil: …<br>Telefon: …<br>Email: iletisim<?php echo e('@'. str_replace(['http://', 'https://'], '', url('/'))); ?></p>
                    <p>ALICI: Müşteri</p>
                    <p><strong>Madde 2 – Sözleşmenin Konusu</strong></p>
                    <p>İş bu sözleşmenin konusu, Alıcının Satıcıya ait <?php echo e(str_replace(['http://', 'https://'], '', url('/'))); ?> web sitesinden elektronik ortamda sipariş verdiği, sözleşmede bahsi geçen nitelikleri haiz ve yine sözleşmede satış fiyatı belirtilen mal/hizmetin satışı ve teslimi ile ilgili olarak 4077 sayılı Tüketicilerin Korunması Hakkındaki Kanun ve Mesafeli Sözleşmeler Uygulama Esas ve Usulleri Hakkında Yönetmelik hükümleri gereğince tarafların hak ve yükümlülüklerinin saptanmasıdır. Alıcı, satışa konu mal/hizmetlerin temel nitelikleri, satış fiyatı, ödeme şekli, teslimat koşulları vs. satışa konu mal/hizmet ile ilgili tüm ön bilgiler ve “cayma” hakkı konusunda bilgi sahibi olduğunu, bu ön bilgileri elektronik ortamda teyit ettiğini ve sonrasında mal/hizmeti sipariş verdiğini iş bu sözleşme hükümlerince kabul ve beyan eder. <?php echo e(str_replace(['http://', 'https://'], '', url('/'))); ?> sitesinde ödeme sayfasında yer alan ön bilgilendirme ve fatura iş bu sözleşmenin ayrılmaz parçalarıdır.</p>
                    ...
                    <p>Mal/hizmetin cinsi ve türü, miktarı, marka/modeli, rengi ve tüm vergiler dâhil satış bedeli <?php echo e(str_replace(['http://', 'https://'], '', url('/'))); ?> adlı web sitesindeki mal/hizmet tanıtım sayfasında yer alan bilgilerde ve iş bu sözleşmenin ayrılmaz parçası sayılan faturada belirtildiği gibidir.</p>
...
<?php elseif(Request::path() == 'uyelik-sozlesmesi'): ?>
...
<?php elseif(Request::path() == 'on-bilgilendirme-formu'): ?>
        ...
        <div id="primary" class="content-area col-xs-12">
            <main id="main" class="site-main" role="main">
                <article id="post-10" class="post-10 page type-page status-publish hentry">
                    ...
                    <p>SATICI</p>
                    <p>ÜNVANI : <?php echo e($seo['author']); ?> <br>ADRES : <?php echo e($iletisim['adres']); ?> <br>TELEFON : <?php echo e($iletisim['tel']); ?><br>WEB : <?php echo e(str_replace(['http://', 'https://'], '', url('/'))); ?><br>E-POSTA : info<?php echo e('@'. str_replace(['http://', 'https://'], '', url('/'))); ?></p>
...
<?php elseif(Request::path() == 'teslimat-kargo'): ?>
        ...
        <div id="primary" class="content-area col-xs-12">
            <main id="main" class="site-main" role="main">
                <article id="post-24" class="post-24 page type-page status-publish hentry">
                    ...
                    <p><?php echo e(str_replace(['http://', 'https://'], '', url('/'))); ?> adresinde tüm alışverişlerinizde kargo ÜCRETSİZDİR.</p>
...
<?php elseif(Request::path() == 'kvkk-beyani'): ?>
        ...
        <div id="primary" class="content-area col-xs-12">
            <main id="main" class="site-main" role="main">
                <article id="post-16" class="post-16 page type-page status-publish hentry">
                    ...
                    <p>İstanbul Ticaret Odası’nın 36658-5 sicil sayısında kayıtlı, <?php echo e($iletisim['adres']); ?> . adresinde bulunan <?php echo e($seo['author']); ?> , KVKK kapsamında Veri Sorumlusu’dur.</p>
                    ...
                    <p>E.posta: info<?php echo e('@'. str_replace(['http://', 'https://'], '', url('/'))); ?></p>
                    <p>Telefon: <?php echo e($iletisim['tel']); ?></p>
                </article>
                <!-- #post-## -->
            </main>
            <!-- #main -->
