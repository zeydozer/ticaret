            ...
            <main id="main" class="site-main" role="main">
                <article id="post-6" class="post-6 page type-page status-publish hentry">
                    <div class="row">
                        <div class="col-12">
                            <header>
                                <h1 class="page-title margin-top"><?php echo e($seo['author']); ?> </h1>
                            </header>
                        </div>
                    </div>
                    <div class="row">
                    	...
                    	<div class="col-md-6">
                            <img src="/img/Noone-Logo-Square.jpg" alt="<?php echo e($seo['author']); ?> Hakkında" width="100%" height="100%" style="object-fit: contain;">
                        </div>
                    </div>
                </article>
                <!-- #post-## -->
