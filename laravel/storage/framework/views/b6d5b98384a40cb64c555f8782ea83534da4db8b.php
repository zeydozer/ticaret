<?php $__env->startSection('title', 'Ödeme Sonucu'); ?>
...
<div class="container">
    ...
    <section class="row payment_successful">
        ...
        <div class="col-xl-12 status text-center <?php echo e(!$durum ? 'mb-0' : ''); ?>">
            <img src="/assets/images/<?php echo e($durum ? 'basarili' : 'basarisiz'); ?>.svg">
            <span class="result">Ödeme <?php echo e($durum ? 'Başarılı' : 'Başarısız'); ?></span>
            <span class="result-text"><?php echo Session::get('mess'); Session::forget('mess'); ?></span>
            <?php if(!$durum): ?> 
            <a href="/odeme">Tekrar Deneyin</a> 
            <?php elseif(Cookie::has('uye')): ?> 
            <a href="/hesap/siparis">Sipariş Takip</a> 
            <?php endif; ?>
        </div>
