...
<div class="login-box">
  <div class="login-logo">
    ...
    <a href="/admin">
      <b><?php echo e($mini[0]); ?></b>

      <?php unset($mini[0]) ?>

      <?php $__currentLoopData = $mini; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $temp): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
       <?php echo e($temp); ?>
  ...
  <div class="login-box-body">
    ...
    <?php if(Request::path() == 'admin/giris'): ?>
    ...
    <form id="ajax-form" method="post">
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <input type="hidden" name="unut_token" value="<?php echo e(md5(mt_rand())); ?>">
    ...
    <?php elseif(Request::path() == 'admin/unuttum'): ?>
