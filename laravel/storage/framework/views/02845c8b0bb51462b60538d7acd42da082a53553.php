                    ...
                    <a href="/urun/<?php echo e($urun->url); ?>">
                        <div class="product-container">
                            ...
                            <div class="prices text-center">
                                ...
                                <?php else: ?>
                                <span class="old invisible d-none d-md-block"><?php echo e(number_format($urun->fiyat, 2, ',', '.')); ?> TL</span>
                            ...
                            <?php else: ?>
                            <span class="winnings invisible d-none d-md-block">Kazancınız %<?php echo e(intval($urun->oran)); ?></span>
                            <?php endif; ?>
                        </div>
                    </a>
                    <div class="hover">
