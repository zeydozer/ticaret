...
<head>
    ...
    <script>
        ...
        fbq('init', '214375832810075');
        fbq('track', 'PageView');
    </script>

    <noscript>
        <img height="1" width="1" style="display:none" 
        src="https://www.facebook.com/tr?id=214375832810075&ev=PageView&noscript=1" />
    </noscript>
    ...
    <meta property="fb:app_id" content="477796949447329" />
	...
	<header>
        ...
        <div class="nav-campaign" style="background: #FF0000">
            <div class="container">
                <span>
                    <strong>
                        Hemen üye olun, ilk alışverişinize özel <?php echo e($indirim['a']); ?> TL'ye 
                        <?php echo e($indirim['b']); ?> TL indirim fırsatını kaçırmayın!
                    </strong>
                </span>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-xl-10 m-auto d-lg-flex">
                        <div class="col-lg-8 px-lg-0 text-left">
                            Copyright &copy; <?php echo e(date('Y')); ?> | <?php echo e($seo['author']); ?>

                        </div>
                        <div class="col-lg-4 px-lg-0 text-right">Designed & Developed by <a href="//hukumdar.com.tr">Hükümdar</a></div>
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function () {
            ...
            if ($(document).width() < 992) {
                ...
                $('.nav-item.dropdown, #alt-menu').find('[data-toggle="dropdown"]').mouseenter(function(e) {
                    ...
                    $('header .navbar, header .nav-middle').css('z-index', 1);
                });
