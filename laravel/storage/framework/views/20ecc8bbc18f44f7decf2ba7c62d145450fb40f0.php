	...
	<header>
        ...
        <div class="nav-campaign" style="background: #FF0000">
            <div class="container">
                <span>
                    <strong>
                        Hemen şimdi üye olun, ilk alışverişinize özel <?php echo e($indirim['a']); ?> TL'ye
                                ...
                                <div class="row dropdown-menu-multiply">
                                    <div class="col-md-8">
                                        <ul class="list-unstyled">
                                            ...
                                            <?php $kategoriler = \App\Kategori::orderBy('bagli_id')->orderBy('sira')->get() ?>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3 col-md-6 col-4">
                                                <a href="/urunler?marka[]=<?php echo e($marka->name); ?>" class="font-weight-bold">
                                                    <img src="/img/<?php echo e($marka->photo); ?>">
                                                    <!-- Bütün Ürünler -->
                                                </a>
                                            </div>
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
