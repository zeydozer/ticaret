        ...
        <div class="row forms">
            ...
            <div class="col-xl-6 col-lg-8 m-auto">
                <div class="row registered-card mb-md-5 mb-3 mt-0 align-items-center">
                    ...
                    <div class="col-md-8 pl-half">
                        {{ Session::has('teslimat') ? Session::get('teslimat') : 'Fatura adresi ile aynı' }}
                    </div>
                    <div class="col-xl-12 mt-3"></div>
                    <div class="col-md-4 pr-half text-md-right">
                        <b>Ara Toplam:</b>
                    ...
                    <div class="col-md-8 price pl-half">
                        {{ number_format($toplam + $kargo, 2, ',', '.') }} TL
                    </div>
                </div>
                ...
                <form class="row" action="/odeme" method="post">
                    ...
                    <div class="col-lg-12 col-md-8 m-auto">
                        <div class="form-line-no-line row text-center">
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                ...
                                <label for="tab-pill-1" style="@if ($odeme['kart'] == 0) cursor: no-drop @endif">
                                    Kart
                                </label>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                ...
                                <label for="tab-pill-2" style="@if ($odeme['havale'] == 0) cursor: no-drop @endif">
                                    Havale / EFT
                                </label>
                            </div>
                            <div class="col-xl-4 col-lg-4 col-md-4 col-12">
                                ...
                                <label for="tab-pill-3" style="@if ($odeme['kapi'] == 0) cursor: no-drop @endif">
                                    Kapıda Ödeme
                                </label>
                            </div>
                        </div>
                    ...
                    <div id="tab-2" class="tab col-lg-12 col-md-9 m-auto">
                        @foreach ($bankalar as $i => $banka)
                        <?php $id = $banka->id; $banka = json_decode($banka->data); ?>
                        <div class="row align-items-center mb-3" style="font-size: 10pt">
                            <div class="col-md-1 col-6">
                                <input type="radio" name="havale" id="banka-{{ $id }}" value="{{ $id }}">
                            </div>
                            <div class="col-md-4 col-6">
                                <label for="banka-{{ $id }}" class="mb-0 mb-md-2">
                                    <img src="/img/{{ $banka->foto }}" class="w-100">
                                </label>
                            </div>
                            <div class="col-md-7 mt-md-0 mt-2">
                                <label for="banka-{{ $id }}">
                                    <h6>{{ $banka->isim }}</h6>
                                    <b>Şube:</b> {{ $banka->sube }} <br>
                                    <b>Kod:</b> {{ $banka->kod }} <br><br>
                                    {{ $banka->iban }}
                                </label>
                            </div>
                        </div>
                    ...
                    <div id="tab-3" class="tab col-lg-12 col-md-8 m-auto">
                        Kapıda Ödeme: <span class="price price mb-md-0 mb-2">{{ number_format($kapi, 2, ',', '.') }} TL</span>
                        <br class="d-none d-md-block">
                        Ödenecek Toplam Tutar: <span class="price">{{ number_format($toplam + $kargo + $kapi, 2, ',', '.') }} TL</span>
                    </div>
...
<form id="ajax-3d" class="d-none" action="https://{{ $bank_url[$pos_info['banka']] }}/fim/est3Dgate" method="post">
