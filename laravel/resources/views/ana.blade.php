...
<div class="container main-content">
    ...
    <section class="row features text-center">

        <?php $limit = \DB::table('ayar')->where('tip', 'ucretsiz')->first()->data ?>

        <div class="col-xl-2 col-lg-4 col-md-4 col-6 main-features">
        ...
        <div class="col-xl-2 col-lg-4 col-md-4 col-6 main-features">
            <div class="features-item">
                <img src="/assets/images/ic6.svg" class="d-none d-md-block">
                <img src="/assets/images/icb6.svg" class="d-block d-md-none">
                <h4>24 SAAT İÇİNDE KARGO</h4>
            </div>
        </div>

        <div class="col-xl-2 col-lg-4 col-md-4 col-6 main-features mt-xl-0 mt-lg-3 mt-md-2">
            <div class="features-item">
                <img src="/assets/images/ic5.svg" class="d-none d-md-block">
                <img src="/assets/images/icb5.svg" class="d-block d-md-none">
        ...
        <div class="col-xl-2 col-lg-4 col-md-4 col-6 main-features mt-xl-0 mt-lg-3 mt-md-2">
            <div class="features-item">
                <img src="/assets/images/ic7.svg" class="d-none d-md-block">
                <img src="/assets/images/icb7.svg" class="d-block d-md-none">
    ...
    <section class="row main-products-a">
        <a class="col-lg-6" href="https://noone.com.tr/urun/fisher-price-mutlu-bulutlar-donence-ve-uyku-arkadasi-besik-icin-ses-makinesi-grp99">
        ...
        <a class="col-lg-6" href="https://noone.com.tr/urun/barbie-nin-malibu-evi-fxg57">
    ...
    <a class="d-block d-lg-none tumunu-incele" href="/urunler?ozellik[]=vitrin">Tümünü İncele</a>
    @endif
    @endif

    @if (isset($yeni_gelen))
    @if (count($yeni_gelen) >= 4)
    <div class="box-title">
        <h2>YENİ GELEN ÜRÜNLER</h2>
    </div>
    <section class="row products justify-content-center">
        @foreach ($yeni_gelen as $urun)
        <div class="col-xl-3 col-lg-3 col-md-6 col-6">
            <a href="/urun/{{ $urun->url }}">
                <div class="product-container">
    ...
    <a class="d-block d-lg-none tumunu-incele" href="/urunler?ozellik[]=yeni">Tümünü İncele</a>
    @endif
    @endif
    ...
    @if (count($ktgler) > 0)
    @foreach ($ktgler as $ktg)
    @php $result = kat_urun($ktg->id) @endphp
    @if (count($result['urunler']) > 0)
    <div class="box-title">
        <h2 class="text-uppercase">{{ $result['title'] }}</h2>
    </div>
    <section class="row products justify-content-center">
        @foreach ($result['urunler'] as $urun)
        <div class="col-xl-3 col-lg-3 col-md-6 col-6">
            <a href="/urun/{{ $urun->url }}">
                <div class="product-container">
    ...
    <a class="d-block d-lg-none tumunu-incele" href="/urunler/{{ $ktg->url }}">Tümünü İncele</a>
    @endif
    @endforeach
    @endif
